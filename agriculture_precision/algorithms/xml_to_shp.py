...
__author__ = 'PERMAGRO & ASPEXIT'
"""
@author: Pierre-Yves Turquin - PERMAGRO
adapted to QGIS by Lisa Rollier
"""
__date__ = '2020-07-21'
...
class XmlToShp(QgsProcessingAlgorithm):
    ...
    def group(self):
        ...
        should be localised.
        """
        return self.tr('Data Conversion')
    
    def shortHelpString(self):
        short_help = self.tr(
            'Convert TelePAC files from XML format to SHP format. \n\n'
            'Before using the function, you need to manually remove one '
            'tag at the beginning of the XML file. This tag is present twice '
            'in the file, which prevents the XML to be read properly. The tag '
            'you need to remove at the very beginning of the XML file looks like '
            'this in general "xmlns="urn:x-telepac:fr.gouv.agriculture.telepac:'
            'echange-producteur\n\n\n\n'
            'provided by ASPEXIT \n '
            'author : Pierre-Yves Turquin - PERMAGRO \n'
            'adapted for QGIS by Lisa Rollier'

...
class EchantillonageRaster(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        layer_coordonnees = processing.run('Agriculture de précision:Ajouter les coordonnees dans un vecteur', alg_params, context=context, feedback=feedback, is_child_algorithm=True)

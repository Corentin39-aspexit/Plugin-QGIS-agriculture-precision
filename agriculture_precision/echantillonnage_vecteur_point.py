...
class EchantillonageVecteurPoint(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config):
        ...
        self.addParameter(
            QgsProcessingParameterVectorLayer(
                self.INPUT,
                self.tr('Couche vecteur à échantillonner'),
        ...
        self.addParameter( 
            QgsProcessingParameterField( 
                self.FIELD, 
                self.tr( "Choix du champ à classer" ), 
                QVariant(),
                self.INPUT,
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        if method == 0 : 
            ...
            layer_class = processing.run('Agriculture de précision:Classification vecteur', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
    ...
    def name(self):
        ...
        """
        return "Echantillonnage sur un vecteur"
    ...
    def group(self):
        ...
        should be localised.
        """
        return self.tr('Action sur Vecteur')
